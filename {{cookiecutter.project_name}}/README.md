...
[![Join the chat at https://gitter.im/{{cookiecutter.github_org}}/{{cookiecutter.project_name}}](https://badges.gitter.im/{{cookiecutter.github_org}}/{{cookiecutter.project_name}}.svg)](https://gitter.im/{{cookiecutter.github_org}}/{{cookiecutter.project_name}}?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
